        ...
        if (PCDheader.data === 'binary_compressed') {
            ...
            for (let i = 0; i < PCDheader.points; i++) {
                if (offset.x !== undefined) {
                    ...
                    position.push(
                        dataview.getFloat32(PCDheader.points * offset.y + PCDheader.size[1] * i, this.littleEndian),
                    );
                    position.push(
                        dataview.getFloat32(PCDheader.points * offset.z + PCDheader.size[2] * i, this.littleEndian),
                    );
                }
